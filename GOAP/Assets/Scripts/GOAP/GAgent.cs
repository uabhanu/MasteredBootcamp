...
namespace GOAP
{
    ...
    public class GAgent : MonoBehaviour
    {
        ...
        private void LateUpdate()
        {
            ...
            {
                //If navmesh agent has a goal and has reached the goal and <1f works only if agents are Unity Size so change this value accordingly until you find a way to do it dynamically
